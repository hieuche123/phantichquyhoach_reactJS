...
const widthImage = 10310 // in pixels
const heightImage = 7290 // in pixels
const mapScale = 25000 // scale of the image map (1:25000)
const widthInMeters = widthImage * mapScale // chiều rộng thực tế của ảnh
const heightInMeters = heightImage * mapScale // chiều cao thực tế của ảnh
...
const imageBounds = {
  north: center.lat + (heightInMeters / 2) * ratioLat,
  south: center.lat - (heightInMeters / 2) * ratioLat,
  east: center.lng + (widthInMeters / 2) * ratioLng,
  west: center.lng - (widthInMeters / 2) * ratioLng
}
