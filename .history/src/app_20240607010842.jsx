...
// Tính tỷ lệ chiều rộng / chiều cao của hình ảnh
const imageAspectRatio = 1031 / 729

// Kích thước hình ảnh
const mapWidth = 10310 // in pixels (đã điều chỉnh cho phù hợp với tỷ lệ)
const mapHeight = mapWidth / imageAspectRatio
...
const imageBounds = {
  north: center.lat + (mapHeight / 2),
  south: center.lat - (mapHeight / 2),
  east: center.lng + (mapWidth / 2),
  west: center.lng - (mapWidth / 2)
}
