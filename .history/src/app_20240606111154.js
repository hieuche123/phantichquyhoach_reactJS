...
// 21.130605906609222, 105.8270048137921
const center = {
  lat: 21.1330,
...
const App = () => {
  const [opacity, setOpacity] = useState(0.35); // Initial opacity
  ...
  return (
    <LoadScript googleMapsApiKey={'AIzaSyBa7UlmsSGVz7NA2HkBdfevTBiwIPP2mdY'}>
      ...
      >
        <GroundOverlay
          url="https://res.cloudinary.com/drwwfkcmg/image/upload/v1717530568/google-map/kgzq4xxfinm1dmv3q5mj.jpg" // Replace with your image URL
          bounds={imageBounds}
          opacity={opacity}
        />
      </GoogleMap>
