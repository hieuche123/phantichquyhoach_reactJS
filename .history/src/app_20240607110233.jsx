...
const imageBounds = {
  north: center.lat + (heightInMeters * ratioLat ),
  south: center.lat - (heightInMeters * ratioLat ),
  east: center.lng + (widthInMeters * ratioLng ),
  west: center.lng - (widthInMeters * ratioLng )
}
